...
Item {
    ...
    Item {
        ...
        MultiEffect {
            anchors.fill: popoverShadow
            source: popoverShadow
            shadowEnabled: true
        ...
        LiquidGlass {
            ...
            aberration: 0.03
            bevelWidth: 20.0
            tintColor: Qt.rgba(root.accentColor.r, root.accentColor.g, root.accentColor.b, 0.25)
            ...
            ColumnLayout {
                    ...
                    RowLayout {
                        ...
                        Text {
                            text: root.timerMode === "end_of_track"
                                ? I18n.tr("Hết bài này", "End of track")
                ...
                ColumnLayout {
                    ...
                    // Row 3: End of Current Track Button
                    Rectangle {
                        id: endTrackBtn
                        Layout.fillWidth: true
                        height: 34
                        ...
                        RowLayout {
                            ...
                            Text {
                                text: I18n.tr("Hết bài hiện tại", "End of current track")
                                font.family: Theme.fontFamily
                                font.pixelSize: 12
                                font.weight: Font.Medium
                                color: "#ffffff"
